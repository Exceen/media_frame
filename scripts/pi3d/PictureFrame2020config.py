...
parse.add_argument("-i", "--no_files_img",  default="/home/pi/scripts/github/media_frame/scripts/pi3d/PictureFrame2020img.jpg", help="image to show if none selected")
...
parse.add_argument("-o", "--font_file",     default="/home/pi/scripts/github/media_frame/scripts/pi3d/fonts/NotoSans-Regular.ttf")
parse.add_argument("-p", "--pic_dir",       default="/home/pi/Pictures")
parse.add_argument("-q", "--shader",        default="/home/pi/scripts/github/media_frame/scripts/pi3d/shaders/blend_new")
...
parse.add_argument(      "--geo_path",      default="/home/pi/scripts/github/PictureFrame2020gpsdata.txt", help="set the local file to store data from geopy - ignored if --load_geoloc is not true")
